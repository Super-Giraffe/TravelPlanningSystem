...
<div class="contain pull-left">
    <form action="DaoSearch.jsp" class="form-inline ">
        ...
        <div class="form-group search">
            <input type="text" name="check" class="form-control" placeholder="请输入景区名称" />
    ...
    <div class="pull-left">
        <table class="table table-hover">
            ...
            <%
                ...
                String sqlQuery = "SELECT * FROM area limit " + startLine + "," + pageSize;//对数据库进行伪分页读取，一次只能读10行
                String sqlAll = "SELECT * FROM area";
