...
<%
    ...
    switch (flag){
        case 0:
            ...
            out.print("<div class='col-md-4' style='margin-right: 10px;flex: 8; margin-left: 10px'>" +
                    "<form class='form-signin' method='post' action='/user/update'>" +
                    "<h2 class='form-signin-heading'>个人信息</h2>" +
                    "<label>用户名:</label>" +
                    "<input type='text' name='userName' id='userName' value='" + user.getUserName() + "' class='form-control' disabled='true'  style='width:300px'><br>" +
                    "<label>年龄:</label>" +
                    "<input type='text' name='age' id='age' value='" + user.getAge() + "' class='form-control' disabled='true' style='width:300px'><br>" +
                    "<label>性别:</label>" +
                    "<input type='text' name='sex' id='sex' value='" + sex + "' class='form-control' disabled='true' style='width:300px'><br>" +
                    "<label>手机号:</label>" +
                    "<input type='text' name='phone' id='phone' value='" + user.getPhone() + "' class='form-control' disabled='true' style='width:300px'>" +
                    "</form>" +
                    "</div>"
            );
            break;
        case 1:
            out.print("<div class='col-md-4' style='margin-right: 10px;flex: 8; margin-left: 10px>" +
                    ...
                    "<input type='text' name='userName' id='userName' value='" + user.getUserName() + "' class='form-control' disabled='true' style='width:300px'><br>" +
                    "<label>手机号</label>" +
                    "<input type='text' name='phone' id='phone' class='form-control' placeholder='请输入手机号' required style='width:300px'><br>" +
        ...
        case 2:
            out.print("<div class='col-md-4' style='margin-right: 10px;flex: 8; margin-left: 10px'>" +
                        "<form class='form-signin' method='post' action='/area/changePwd'>" +
                            ...
                            "<input type='text' name='userName' id='userName' value='" + user.getUserName() + "' class='form-control' disabled='true' style='width:300px'><br>" +
                            "<label>密码</label>" +
                            "<input type='password' name='password1' id='password' class='form-control' placeholder='请输入密码' required style='width:300px'><br>" +
                            "<button type='submit' class='btn btn-primary' id='btn-login'>确定</button>" +
                        "</form>" +
                    "</div>"
            );
